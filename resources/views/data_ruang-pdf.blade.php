                ...
                <table width="100%" style="margin-bottom: 10px;">
                    <tr>
                        ...
                        <td style="width: 25%;" align="left">
                            <img src="{{ public_path('images/logosit.jpg') }}" style="height: 80px;" alt="Logo SDIT">
                        </td>

                        <!-- Kolom Tengah (Judul) -->
                        <td style="width: 50%;" align="center">
                            <h1 style="margin: 0; font-weight: bold;">Data Inventaris Prasarana SIT Nurul Akbar</h1>
                        </td>

                        <!-- Kolom Kanan (Kosong untuk penyeimbang) -->
                ...
                <table class="w-full border-collapse border-spacing-0" align="center">
                    <thead>
                        <tr>
                            ...
                            <td class="border-b-2 border-main pb-3 pl-2 font-bold text-main">Jenis </td>
                    ...
                    <tbody>
                        @forelse ($data_ruang as $index => $data)
                            <tr>
